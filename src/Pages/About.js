  ...
  return (
    <main className="container mx-auto max-width pt-10 pb-20 mt-20">
      <section>
        ...
        <p className=" py-8 lg:max-w-3xl text-teal-500 font-medium">Hey👋, I am an Electronics and Communication Engineering student at BIET Jhansi(affiliated to Dr. A.P.J. Abdul Kalam Technical University, Lucknow), graduating in 2024 with an aggregate CGPA of 7.11 . I have solved over 800+ DSA(Data Structures and Algorithms) problems on Leetcode and GeeksforGeeks. I have also completed SQL,Problem Solving in C++, Javascript certifications on Hackerrank platform from basic to advance level. Alongwith this, I have worked on technologies like C++, JavaScript, HTML, CSS, React.js, Redux,Node.js  MongoDB, Express.js, Tailwind CSS, Bootstrap, SQL, MySQL during my bachelor's.
        <br></br>
        <br></br>
